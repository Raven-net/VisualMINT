...
class Surface {
  constructor() {
    ...
    this.surface.push(new box2d.b2Vec2(0, height * 0.8));
    this.surface.push(new box2d.b2Vec2(width / 2, height - 20));
    this.surface.push(new box2d.b2Vec2(width, height * 0.8));
